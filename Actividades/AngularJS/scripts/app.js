...
app.controller("EquiposCtrl", function ($scope) {


    for (var i = 0; i < DataJson.length; i++) {

        Equipos.push([DataJson[i].home_team_country,DataJson[i].home_team.code]);
        Equipos.push([DataJson[i].away_team_country,DataJson[i].away_team.code]);

    }

    $scope.ejemploEquipos = Equipos;
